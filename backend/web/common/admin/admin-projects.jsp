  ...
  <div class="search-and-user">
    <%
      ...
      if (searchValue == null)
      	searchValue = "";
    %>
    <form method="get" action="admin-projects.jsp?searchValue=<%=searchValue%>">
      <input name="searchValue" type="search" placeholder="Search Projects..." value="<%=searchValue%>"/>
    ...
    <table>
      ...
      <%
        ...
        if (request.getParameter("searchValue")!=null)
          searchStr = request.getParameter("searchValue");
      ...
      <tr>
        ...
        <td class="delete">
          <a href="${pageContext.request.contextPath}/AdminDeleteProjectServlet?project_id=<%=project.id%>">
